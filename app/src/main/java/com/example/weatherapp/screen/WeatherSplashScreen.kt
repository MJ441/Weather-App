...
val defalultCity = "San Diego"
    ...
    LaunchedEffect(key1 = true, block ={
        ...
        delay(2000L)
        navController.navigate(WeatherScreen.MainScreen.name + "/$defalultCity")
   ...
   shape = CircleShape, color = Color.White, border = BorderStroke(width = 2.dp, color = Color.LightGray),
       ...
       Column(modifier = Modifier.padding(1.dp),
           ...
           Image(painter = painterResource(id = R.drawable.weather), contentDescription = "")
